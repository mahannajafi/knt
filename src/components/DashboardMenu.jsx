    ...
    return (
        <>
            <div className="dashboardMenuContainer">
                ...
                <ul>
                    <li onClick={() => setCount(1)}><PersonIcon className="menuIcons" />&nbsp;&nbsp;&nbsp;اطلاعات کاربری</li>
                    ...
                    <li onClick={() => setCount(4)}><DesignServicesIcon className="menuIcons" />&nbsp;&nbsp;&nbsp;طرح های من</li>
                    <li onClick={() => setCount(5)}><EqualizerIcon className="menuIcons" />&nbsp;&nbsp;&nbsp;آمار فروش</li>
                    <li onClick={() => setCount(6)}><MailOutlineIcon className="menuIcons" />&nbsp;&nbsp;&nbsp;پیام های من</li>
